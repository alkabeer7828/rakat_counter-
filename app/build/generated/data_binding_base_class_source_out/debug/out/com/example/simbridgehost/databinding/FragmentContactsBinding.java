...
public final class FragmentContactsBinding implements ViewBinding {
  ...
  private FragmentContactsBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView recyclerContacts, @NonNull TextView tvEmpty) {
  ...
  public static FragmentContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactsBinding((FrameLayout) rootView, recyclerContacts, tvEmpty);
    }
